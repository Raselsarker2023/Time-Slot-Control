"""
Django settings for Task_tracker_app project.
...
SECRET_KEY = 'django-insecure-l^lrr=el59v2&k6g7y%o&v6s89_jrul7*y$mj$urs$m@!tyjhg'
...
WSGI_APPLICATION = 'Task_tracker_app.wsgi.application'
